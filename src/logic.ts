...
function main(): void {
  ...
  console.log("Please Enter the Input File..");
  ...
  console.log("Please Enter the Sorting Order..");
  ...
  console.log("Please Enter the algoName..");
  ...
  console.log("Please Enter the output file");
  ...
  if (sortedOrder === "asc" && algoName === "merge") {
    numberSorter.sortAscending();
  } else if (sortedOrder === "desc" && algoName === "merge") {
    numberSorter.sortDescending();
  }
